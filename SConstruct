...
envAda.AdaProgram('hollowsquare.adb')
envAda.AdaProgram('triangle.adb')
envAda.AdaProgram('fibo.adb')
envAda.AdaProgram('craps.adb')
envAda.AdaProgram('mean.adb')
envAda.AdaProgram('pascal.adb')
